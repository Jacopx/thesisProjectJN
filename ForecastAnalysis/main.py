...
def main(dataset):
    ...
    if dataset in 'SFBS':
        ...
        # FORECAST
        forecast.model_keras_nn('data/hadoop-version_2_prior-1.csv')
        forecast.model_keras_nn('data/hadoop-version_2_prior-2.csv')
        forecast.model_keras_nn('data/hadoop-version_2_prior-4.csv')
        forecast.model_keras_nn('data/hadoop-version_2_prior-8.csv')
        forecast.model_keras_nn('data/hadoop-version_2_prior-10.csv')
        forecast.model_keras_nn('data/hadoop-version_2_prior-12.csv')
        forecast.model_keras_nn('data/hadoop-version_2_prior-16.csv')
        forecast.model_keras_nn('data/hadoop-version_2_prior-20.csv')
        forecast.model_keras_nn('data/hadoop-version_2_prior-30.csv')
        forecast.model_keras_nn('data/hadoop-version_2_prior-40.csv')
        forecast.model_keras_nn('data/hadoop-version_2_prior-52.csv')
