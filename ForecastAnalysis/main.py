...
def main(dataset):
    ...
    if dataset in 'SFBS':
        ...
        forecast.model_keras_nn('data/hadoop_mixed_prior1')
        # forecast.model_keras_nn('data/hadoop_mixed_prior2')
        # forecast.model_keras_nn('data/hadoop_mixed_prior4')
        # forecast.model_keras_nn('data/hadoop_mixed_prior6')
        # forecast.model_keras_nn('data/hadoop_mixed_prior8')
        # forecast.model_keras_nn('data/hadoop_mixed_prior10')
        # forecast.model_keras_nn('data/hadoop_mixed_prior12')
        # forecast.model_keras_nn('data/hadoop_mixed_prior16')
        #
